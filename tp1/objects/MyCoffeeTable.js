...
class MyCoffeeTable {
    ...
    build(tableRadius, tableHeight, tableMaterial, legRadius, legHeight, legMaterial, radialSegments) {
        ...
        coffeeTableLeg1.position.y = -legHeight / 2;
        ...
        coffeeTableLeg2.position.y = -legHeight / 2;
        ...
        coffeeTableLeg3.position.y = -legHeight / 2;
        ...
        coffeeTableLeg4.position.y = -legHeight / 2;
