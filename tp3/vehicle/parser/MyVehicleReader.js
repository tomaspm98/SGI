...
import { MyVehicleData } from './MyVehicleData.js';
/**
...
class MyVehicleReader {

	/**
	   constructs the object
	   @param {MyApp} app The application object
	*/
	constructor(contents, onSceneLoadedCallback) {
		this.contents = contents;
		this.xmlhttp = null;
		this.xmlDoc = null;
		this.xmlloaded = false;
		this.data = new MyVehicleData();
